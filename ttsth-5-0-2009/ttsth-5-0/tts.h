...
extern int *globalMapVariable, *globalUnMapVariable, globalMaxVariable, *singletonUsage, *isSingleton, *globalUsed, *globalPermute,
*globalUnpermute, *globalTransform, *globalUnTransform, numThreads;
