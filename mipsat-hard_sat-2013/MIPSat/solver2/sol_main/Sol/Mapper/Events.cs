...
namespace Sol
{
	...
	{
		public event EventHandler<EventArgs> RefineEvent;

		protected void OnRefine(EventArgs e)
		{
			EventHandler<EventArgs> RaiseEvent = RefineEvent;
			if (RaiseEvent != null) RaiseEvent(this, e);
		}

		public event EventHandler<EventArgs> SplitEvent;

		protected void OnSplit(EventArgs e)
		{
			EventHandler<EventArgs> RaiseEvent = SplitEvent;
			if (RaiseEvent != null) RaiseEvent(this, e);
		}

		public event EventHandler<EventArgs> AutomorphismEvent;

		protected void OnAutomorphism(EventArgs e)
		{
			EventHandler<EventArgs> RaiseEvent = AutomorphismEvent;
			if (RaiseEvent != null) RaiseEvent(this, e);
		}
	}
}
